...
;!function(t){t.fn.autoDialog=function(e){"use strict";function o(e,o){this.opts=o,this._this=t(e),this.isIE6=/MSIE 6.0/.exec(navigator.userAgent),this.init()}var e=arguments[0],i=arguments[1];if("object"==typeof e)var n=t.extend(!0,{},{title:"",show:!1,width:450,className:null,defaultCss:!0,bgClose:!1,move:!1,isShowClose:!0,content:"",closeFun:null},e);else if("string"!=typeof e)throw new Error("Dialog Parameter error : options error !");return o.prototype={init:function(){var e=this,o='<div class="auto-dialog '+(e.opts.className||"")+'"  style="display: none;">		<div class="dialog-container" style="width:'+(e.opts.width||450)+'px;">			<h4 class="dialog-head">				<span class="dialog-title">'+(e.opts.title||"")+"</span>"+(e.opts.isShowClose?'<a href="javascript:;" class="dialog-close">×</a>':"")+'			</h4>			<div class="dialog-body"></div>		</div>		<div class="dialog-bg"></div></div>';e.myDialog=t(o.replace(/>\s+</g,"><")).appendTo(document.body),e.container=t(".dialog-container",e.myDialog).get(0),e.bg=t(".dialog-bg",e.myDialog).get(0),e.content=t(".dialog-body",e.myDialog).get(0),e.closebtn=t(".dialog-close",e.myDialog).get(0),e._this.show().appendTo(e.content),e.attachEventFun(),e.isIE6&&e.bgResize(),e.opts.show&&setTimeout(function(){e.open()},500)},insertCssFun:function(){if(t("#autoDialogCss").length&&this.opts.defaultCss)return!1;var e=t("head"),o=document.createElement("link");o.id="autoDialogCss",o.rel="stylesheet",o.type="text/css",o.href="http://cdn01.51autoimg.com/51auto/js/util/51autodialog/css/51autodialog.min.css",e.children("link").length?e.children("link:eq(0)").before(o):e.append(o)},stopBubble:function(t){t&&t.stopPropagation?t.stopPropagation():window.event.cancelBubble=!0},attachEventFun:function(){var e=this;t(e.closebtn).on("click.51autodialog",this,function(t){return e.close(),e.stopBubble(t),!1}),t(window).resize(function(){setTimeout(function(){e.boxResize()},200)}),e.opts.bgClose&&t(e.bg).on("click.51autodialog",this,function(t){return e.close(),e.stopBubble(t),!1}),e.opts.move&&e.moveBox()},bgResize:function(){var e=this;t(e.bg).css({width:t(document.body).outerWidth(),height:t(document.body).outerHeight()})},boxResize:function(){var e=this,o=t(e.container);if(e.myDialog.is(":visible")){e.opts.height=e.opts.height||o.outerHeight();var i=t(window).width(),n=t(window).height(),s=e.opts.width,a=e.opts.height,l=e.setSize(s,i-40),c=e.setSize(a,n-40);o.css(e.opts.move?{left:i>=s?(i-s-40)/2:20,top:n>=a?(n-a-40)/2:20,margin:0,width:l,height:c}:{"margin-left":l/2*-1,"margin-top":c/2*-1,width:l,height:c})}},setSize:function(t,e){return t>e?e:t},moveBox:function(){var e=this,o=0,i=0,n=t(e.container),s=t(window).width(),a=t(window).height();n.on("mousedown.51autodialog",this,function(t){var l=document,c=t||window.event;o=(c.pageX||c.clientX)-parseInt(e.container.style.left),i=(c.pageY||c.clientY)-parseInt(e.container.style.top),e.container.style.cursor="move",e.container.setCapture?e.container.setCapture():window.captureEvents&&window.captureEvents(Event.MOUSEMOVE|Event.MOUSEUP),l.onmousemove=function(t){var l=t||window.event,c=l.pageX||l.clientX,r=l.pageY||l.clientY;setTimeout(function(){var t=e.opts.width,l=e.opts.height,u=c-o,d=r-i;0>=u||0>=d||u>=s-t||d>=a-l||n.css({left:u,top:d,margin:0})},75)},l.onmouseup=function(){e.container.releaseCapture?e.container.releaseCapture():window.captureEvents&&window.captureEvents(Event.MOUSEMOVE|Event.MOUSEUP),e.container.style.cursor="auto",l.onmousemove=null,l.onmouseup=null,l.ondragstart=null,l.onselectstart=null,l.onselect=null}})},setZindexFun:function(){var e=this,o=t(".auto-dialog:visible").length;t(e.container).css({"z-index":10001+2*o}),t(e.bg).css({"z-index":1e4+2*o})},writeHtmlFun:function(){var t=this;""!=t.opts.content&&t._this.html(t.opts.content)},open:function(){var t=this;t.writeHtmlFun(),t.myDialog.is(":hidden")&&(t.setZindexFun(),t.myDialog.show(),t.boxResize())},close:function(){var e=this;e.myDialog.is(":visible")&&(e.myDialog.hide(),t.isFunction(e.opts.closeFun)&&e.opts.closeFun(e))}},this.each(function(){var s=t(this),a=s.data("dialog");a||s.data("dialog",a=new o(this,n)),"string"==typeof e&&/^(open|close)$/.test(e)&&("open"==e&&i&&""!=i&&(a.opts.content=i),a[e]())})}}(jQuery);
...
;!function(e){e.fn.extend({jScroll:function(t){t=e.extend({auto:2e3,speed:800,vertical:!1,scroll:1},t),e(this).each(function(){var i,n,r,l,c,o=!1,a=t.vertical?"height":"width",s=0,d=e(this),h=d.find("ul"),f=h.children("li");for(d.css({overflow:"hidden"}),h.css({margin:"0",padding:"0",display:"inline-block"}),f.css({"list-style-type":"none","float":t.vertical?"none":"left"}),c=0;c<=f.size()-1;c++)r=t.vertical?f.eq(c).outerHeight():f.eq(c).outerWidth(),s+=r;var u=t.vertical?d.height():d.width();h.css(a,2*s+"px"),s>u&&(o=!0),d.hover(function(){clearInterval(i)},function(){o&&(i=setInterval(function(){for(n=0,r=0,f=h.children("li"),c=0;c<=t.scroll-1;c++)r=t.vertical?f.eq(c).outerHeight():f.eq(c).outerWidth(),n+=r;l=t.vertical?{marginTop:-n+"px"}:{marginLeft:-n+"px"},h.animate(l,t.speed,function(){h.css(t.vertical?"margin-top":"margin-left","0"),f.slice(0,t.scroll).appendTo(h)})},parseInt(t.auto+t.speed)))}).trigger("mouseleave")})}})}(jQuery);
...
;!function(e){e.fn.validationEngineLanguage=function(){},e.validationEngineLanguage={newLang:function(){e.validationEngineLanguage.allRules={required:{regex:"none",alertText:"* 此处不可空白",alertTextCheckboxMultiple:"* 请选择一个项目",alertTextCheckboxe:"* 您必须钩选此栏",alertTextDateRange:"* 日期范围不可空白"},requiredInFunction:{func:function(e){return"test"==e.val()?!0:!1},alertText:"* Field must equal test"},dateRange:{regex:"none",alertText:"* 无效的 ",alertText2:" 日期范围"},dateTimeRange:{regex:"none",alertText:"* 无效的 ",alertText2:" 时间范围"},minSize:{regex:"none",alertText:"* 最少 ",alertText2:" 个字符"},maxSize:{regex:"none",alertText:"* 最多 ",alertText2:" 个字符"},groupRequired:{regex:"none",alertText:"* 你必需选填其中一个栏位"},min:{regex:"none",alertText:"* 最小值為 "},max:{regex:"none",alertText:"* 最大值为 "},past:{regex:"none",alertText:"* 日期必需早于 "},future:{regex:"none",alertText:"* 日期必需晚于 "},maxCheckbox:{regex:"none",alertText:"* 最多选取 ",alertText2:" 个项目"},minCheckbox:{regex:"none",alertText:"* 请选择 ",alertText2:" 个项目"},equals:{regex:"none",alertText:"* 请输入与上面相同的密码"},creditCard:{regex:"none",alertText:"* 无效的信用卡号码"},phone:{regex:/^([\+][0-9]{1,3}([ \.\-])?)?([\(][0-9]{1,6}[\)])?([0-9 \.\-]{1,32})(([A-Za-z \:]{1,11})?[0-9]{1,4}?)$/,alertText:"* 无效的电话号码"},mobile:{regex:/^(13[0-9]|14[6|7]|15[0|1|2|3|5|6|7|8|9]|18[0-9]|17[0-9])\d{8}$/,alertText:"* 无效的手机号码"},email:{regex:/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i,alertText:"* 邮件地址无效"},integer:{regex:/^[\-\+]?\d+$/,alertText:"* 不是有效的整数"},number:{regex:/^[\-\+]?((([0-9]{1,3})([,][0-9]{3})*)|([0-9]+))?([\.]([0-9]+))?$/,alertText:"* 无效的数字"},date:{regex:/^\d{4}[\/\-](0?[1-9]|1[012])[\/\-](0?[1-9]|[12][0-9]|3[01])$/,alertText:"* 无效的日期，格式必需为 YYYY-MM-DD"},name:{regex:/(^(?!(您的姓名))[A-Za-z0-9\u4e00-\u9fa5]{1,10}$)/,alertText:"* 请输入正确的姓名！"},ipv4:{regex:/^((([01]?[0-9]{1,2})|(2[0-4][0-9])|(25[0-5]))[.]){3}(([0-1]?[0-9]{1,2})|(2[0-4][0-9])|(25[0-5]))$/,alertText:"* 无效的 IP 地址"},url:{regex:/^(https?|ftp):\/\/(((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(\#((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?$/i,alertText:"* Invalid URL"},onlyNumberSp:{regex:/^[0-9\ ]+$/,alertText:"* 只能填数字"},onlyLetterSp:{regex:/^[a-zA-Z\ \']+$/,alertText:"* 只接受英文字母大小写"},onlyLetterAccentSp:{regex:/^[a-z\u00C0-\u017F\ ]+$/i,alertText:"* 只接受英文字母大小写"},onlyLetterNumber:{regex:/^[0-9a-zA-Z\u4e00-\u9fa5]+$/,alertText:"* 不接受特殊字符,只能输入中文、数字、字母"},ajaxUserCall:{url:"ajaxValidateFieldUser",extraData:"name=eric",alertText:"* 此名称已被其他人使用",alertTextLoad:"* 正在确认名称是否有其他人使用，请稍等。"},ajaxUserCallPhp:{url:"phpajax/ajaxValidateFieldUser.php",extraData:"name=eric",alertTextOk:"* 此帐号名称可以使用",alertText:"* 此名称已被其他人使用",alertTextLoad:"* 正在确认帐号名称是否有其他人使用，请稍等。"},ajaxNameCall:{url:"ajaxValidateFieldName",alertText:"* 此名称可以使用",alertTextOk:"* 此名称已被其他人使用",alertTextLoad:"* 正在确认名称是否有其他人使用，请稍等。"},ajaxNameCallPhp:{url:"phpajax/ajaxValidateFieldName.php",alertText:"* 此名称已被其他人使用",alertTextLoad:"* 正在确认名称是否有其他人使用，请稍等。"},validate2fields:{alertText:"* 请输入 HELLO"},dateFormat:{regex:/^\d{4}[\/\-](0?[1-9]|1[012])[\/\-](0?[1-9]|[12][0-9]|3[01])$|^(?:(?:(?:0?[13578]|1[02])(\/|-)31)|(?:(?:0?[1,3-9]|1[0-2])(\/|-)(?:29|30)))(\/|-)(?:[1-9]\d\d\d|\d[1-9]\d\d|\d\d[1-9]\d|\d\d\d[1-9])$|^(?:(?:0?[1-9]|1[0-2])(\/|-)(?:0?[1-9]|1\d|2[0-8]))(\/|-)(?:[1-9]\d\d\d|\d[1-9]\d\d|\d\d[1-9]\d|\d\d\d[1-9])$|^(0?2(\/|-)29)(\/|-)(?:(?:0[48]00|[13579][26]00|[2468][048]00)|(?:\d\d)?(?:0[48]|[2468][048]|[13579][26]))$/,alertText:"* 无效的日期格式"},dateTimeFormat:{regex:/^\d{4}[\/\-](0?[1-9]|1[012])[\/\-](0?[1-9]|[12][0-9]|3[01])\s+(1[012]|0?[1-9]){1}:(0?[1-5]|[0-6][0-9]){1}:(0?[0-6]|[0-6][0-9]){1}\s+(am|pm|AM|PM){1}$|^(?:(?:(?:0?[13578]|1[02])(\/|-)31)|(?:(?:0?[1,3-9]|1[0-2])(\/|-)(?:29|30)))(\/|-)(?:[1-9]\d\d\d|\d[1-9]\d\d|\d\d[1-9]\d|\d\d\d[1-9])$|^((1[012]|0?[1-9]){1}\/(0?[1-9]|[12][0-9]|3[01]){1}\/\d{2,4}\s+(1[012]|0?[1-9]){1}:(0?[1-5]|[0-6][0-9]){1}:(0?[0-6]|[0-6][0-9]){1}\s+(am|pm|AM|PM){1})$/,alertText:"* 无效的日期或时间格式",alertText2:"可接受的格式： ",alertText3:"mm/dd/yyyy hh:mm:ss AM|PM 或 ",alertText4:"yyyy-mm-dd hh:mm:ss AM|PM"},noRepeatFunction:{func:function(F){return F.val()!==e("#owners").val()?!0:!1},alertText:"* 车主接待人与经销商接待人不能是同一个人！"}}}},e.validationEngineLanguage.newLang()}(jQuery);
;window.GlobalClass=window.GlobalClass||{tipsDialog:function(a,i,t,n){var e={ok:'<i class="icon icon-ok"></i>',error:'<i class="icon icon-error"></i>'};if($("#"+a).length)$("#"+a).autoDialog("open",'<div class="my-msg">'+(e.hasOwnProperty(i)?e[i]:"")+t+"</div>");else{var o=$('<div id="'+a+'" style="display: none;"></div>').appendTo("body");o.autoDialog({title:"系统提示",show:!0,width:450,isShowClose:"boolean"==typeof n?n:!0,content:'<div class="my-msg">'+(e.hasOwnProperty(i)?e[i]:"")+t+"</div>"})}},stopBubble:function(a){a&&a.stopPropagation?a.stopPropagation():window.event.cancelBubble=!0},throttle:function(a,i,t){var n,e=null;return function(){var o=this,l=arguments,s=+new Date;clearTimeout(e),n||(n=s),s-n>=t?(a.apply(o,l),n=s):e=setTimeout(function(){a.apply(o,l)},i)}},formValidationFun:function(a,i){$(a).validationEngine({promptPosition:"topLeft",scroll:!1,autoHidePrompt:!0,autoHideDelay:5e3}),$(a).on("click",".btn-ok",function(){console.log("1111");var t=$(this).prop("disabled");return t||!$(a).validationEngine("validate")?!1:($(this).prop("disabled",!0),i&&$.isFunction(i)&&i(),setTimeout(function(){$(a).submit()},3e3),void 0)})},getFormJson:function(a){var i={},t="";return $.each(a.serializeArray(),function(a,n){t=n.name,i[t]=n.value}),JSON.stringify(i)},formSubmitFun:function(a,i,t){if(a.length){var n=this;return a.validationEngine({promptPosition:"topLeft",scroll:!1,autoHideDelay:3e3}),a.validationEngine("validate")?void $.ajax({url:a.attr("action"),type:a.attr("method"),data:n.getFormJson(a),dataType:"json",timeout:3e4,headers:{Accept:"application/json; charset=utf-8","Content-Type":"application/json; charset=utf-8"},success:function(a){"200"===a.code.toString()?$.isFunction(i)&&i(a):(n.tipsDialog("tips","error",a.message),$.isFunction(t)&&t())},error:function(){n.tipsDialog("tips","error","服务器链接失败，请重试！"),$.isFunction(t)&&t()}}):!1}},tabFun:function(){var a=$(".tab");a.length&&a.on("click",".tag",function(){var a=$(this).parents(".tab"),i=$(this).index();$(this).addClass("on").siblings(".tag").removeClass("on"),a.children(".con").eq(i).addClass("show").siblings(".con").removeClass("show")})},getUrlQueryString:function(a){a=a.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");var i=new RegExp("[\\?&]"+a+"=([^&#]*)"),t=i.exec(location.search),n=null;return null===t?null:(n=t[1].replace(/\+/g," "),decodeURIComponent(n))},setPagination:function(a,i){var t=i.form||"form",n=parseInt(i.maxsize),e=parseInt(i.pagesize),o=parseInt(this.getUrlQueryString("page")?this.getUrlQueryString("page"):i.page),l=Math.ceil(n/e),s=l>9?9:l,r=0>=o-5?1:o+4>=l?l+1-s:o-4,c=o+4>=l?l:s>o+4?s:o+4,p="";if(p='<div class="total pull-left">\n<span class="text-primary arial">'+((o-1)*e+1)+"-"+o*e+'条</span>\n<span> / 共</span>\n<span class="text-primary arial">'+n+'</span>\n<span>条</span>\n</div>\n<ul class="page-list pull-right">\n',0!=n){p+=1==o?'<li class="disabled"><a href="javascript:void(0);" aria-label="Previous"><span aria-hidden="true" title="上一页">&laquo;</span></a></li>\n':'<li data-page="'+(o-1)+'" ><a href="javascript:void(0);"aria-label="Previous" title="上一页"><span>&laquo;</span></a></li>\n';for(var d=r;c+1>d;d++)p+=d==o?'<li class="active"><a href="javascript:void(0);" title="第'+d+'页">'+d+"</a></li>\n":'<li data-page="'+d+'"><a href="javascript:void(0);"  title="第'+d+'页">'+d+"</a></li>\n";p+=o==l?'<li class="disabled"><a href="javascript:void(0);" aria-label="Next" title="下一页"><span aria-hidden="true">&raquo;</span></a></li>\n':'<li data-page="'+(o+1)+'" ><a href="javascript:void(0);" aria-label="Next" title="下一页"><span>&raquo;</span></a></li>\n'}p+="</div>\n",a.html(p),a.on("click",".page-list li",function(){var a=$(this).attr("class");if("disabled"===a||"active"===a)return!1;var i=$(this).data("page");$(t).find("[name='page']").val(i),$(t).submit()})},rightFixedFun:function(){{var a=$(".r-fixed"),i=a.children(".goTop");$(window).height()}a.length&&(a.removeClass("hide").children("goTop").addClass("hide"),$(window).scroll(GlobalClass.throttle(function(){$(window).scrollTop()<100?i.addClass("hide"):i.removeClass("hide")},200,400)),a.on("click",".goTop",function(){return $("html,body").animate({scrollTop:0},function(){i.addClass("hide")}),!1}))}},$(function(){GlobalClass.rightFixedFun(),GlobalClass.tabFun()});